...
model0 <- glmer(response~td  + (1|id)+(1|param_value), data=subturk, control=glmerControl(optimizer="bobyqa"), family=binomial())
...
model0a <- glmer(response~td  + (1|id)+(1|param_value), control=glmerControl(optimizer="bobyqa"),  data=subset(subturk, type==1), family=binomial())
model0b <- glmer(response~td  + (1|id)+(1|param_value), control=glmerControl(optimizer="bobyqa"), data=subset(subturk, type==2), family=binomial())
model0c <- glmer(response~td  + (1|id)+(1|param_value), control=glmerControl(optimizer="bobyqa"), data=subset(subturk, type==3), family=binomial())
